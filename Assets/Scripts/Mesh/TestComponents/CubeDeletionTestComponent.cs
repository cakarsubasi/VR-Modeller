...
public class CubeDeletionTestComponent : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        meshInternal.DeleteGeometry(meshInternal.FindByPosition(float3(-1f, -1f, -1f)),
            meshInternal.FindByPosition(float3(-1f, -1f, 1f)));
        meshInternal.WriteAllToMesh();
    }
